...
class RepresentativePeriodTimeGenerator:
    """Implements Behavior in the Representative Period Time."""

    def __init__(self, model: RepresentativePeriodTime, *args, **kwargs):
        self._model = model
    ...
    def list_time_columns(self) -> list[str]:
        return self._handler.list_time_columns()
...
class OneWeekPerMonthByHourHandler(RepresentativeTimeFormatHandlerBase):
    ...
    def list_time_columns(self) -> list[str]:
        return list(self.time_type._fields)
